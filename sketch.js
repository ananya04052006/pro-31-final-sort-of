...
function draw() {
  ...
  if(frameCount % 60 === 0) {
    particles.push(new Particle(random(width/4 - 10, width/4 + 20), 10, 10))
  }
  ...
  /*if(frameCount % 60 === 0) {
    plinkos.push(new Plinko(random(width/4 - 10, width/4 + 20), 10, 10))
  }

  for(var l = 40; l < plinkos.length; l++) {
    plinkos[l].display();
  }
